...
namespace AutoAnalyticsServer.InMemoryModel
{
    public partial class AutoAnalyticsInMemoryContext : DbContext, IAutoAnalyticsContext
    {
        public AutoAnalyticsInMemoryContext()
        {
        }

        public AutoAnalyticsInMemoryContext(DbContextOptions<AutoAnalyticsInMemoryContext> options)
            : base(options)
        {
        }
